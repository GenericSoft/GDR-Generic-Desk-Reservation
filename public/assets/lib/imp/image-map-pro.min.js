...
(() => {
  var __webpack_modules__ = {
              ...
              },
              {
                ...
                value: function () {
                  return this.options.parent
                    ? this.store
                        .getChildrenDeep({ id: this.options.parent })
                        .map(function (t) {
                          return t.id;
                        })
                    : this.options.single_object
                    ? this.store
                        .getChildrenDeep({ id: this.options.id })
                        .map(function (t) {
                          return t.id;
                        })
                    : [this.options.id];
                ...
                value: function () {
                  ...
                  try {
                    for (n.s(); !(t = n.n()).done; ) {
                      var i = t.value;
                      e.push(
                        this.store.getObjectController().objects[i.id].getRect()
                      );
                    }
                  } catch (t) {
                    n.e(t);
                  ...
                  try {
                    for (n.s(); !(t = n.n()).done; ) {
                      ...
                      e.push(
                        this.store
                          .getObjectController()
                          .objects[i.id].getBoundingClientRect()
                      );
                    }
                  } catch (t) {
                    n.e(t);
          ...
          a = (function () {
            function t(e, n) {
              (0, o.Z)(this, t),
                ...
                (this.styles =
                  this.createStyles() + this.createStyleExceptions()),
                (this.imageBackgroundElement =
                  this.createImageBackgroundElement()),
                (this.slaves = []),
              ...
              (0, i.Z)(t, [
                { key: 'createElement', value: function () {} },
                {
                  ...
                  value: function () {
                    ...
                    (t += this.createCSSRules(this.options.default_style)),
                      (t += '} \n\n');
                    ...
                    return (
                      t +
                      ((e += this.createCSSRules(
                        this.options.mouseover_style
                      )) +
                        '} \n\n')
                    );
                  },
                ...
                },
                {
                  ...
                  value: function () {
                    'grow' ===
                      this.store.state.objectConfig.pageload_animation &&
                      this.element.classList.add('imp-pageload-animation-grow'),
                      'fade' ===
                        this.store.state.objectConfig.pageload_animation &&
                        this.element.classList.add(
                          'imp-pageload-animation-fade-in'
                        ),
                      'fall-down' ===
                        this.store.state.objectConfig.pageload_animation &&
                        this.element.classList.add(
                          'imp-pageload-animation-fall-down'
                        );
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function () {
                    this.element.classList.add('imp-object-highlighted'),
                      'image' ===
                        this.options.mouseover_style.background_type &&
                        ((this.imageBackgroundElement.style.backgroundImage =
                          'url("'.concat(
                        ...
                        (this.imageBackgroundElement.style.transform =
                          'scale('.concat(
            ...
            (0, i.Z)(p, [
              {
                ...
                value: function () {
                  var t = document.createElement('div');
                  if (
                    (t.classList.add('imp-object-spot'),
                    ...
                    if (
                      ...
                      var n = '<img src="'
                        .concat(
                          this.options.default_style.icon_url,
                          '" style="width: '
                        )
                        .concat(
                          this.options.default_style.icon_size,
                    ...
                    if (this.options.default_style.icon_shadow) {
                      ...
                      var i = '<div style="'.concat(
                        o,
                        '" class="imp-object-icon-shadow"></div>'
                      );
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (!this.options.default_style.use_icon) {
                    ...
                    var r = (0, l.oo)(t.background_color) || {
                        r: 0,
                        b: 0,
                        g: 0,
                      },
            ...
            (0, i.Z)(p, [
              {
                ...
                value: function () {
                  var t = document.createElement('div');
                  return (
                    t.classList.add('imp-object-text'),
                    (t.innerHTML = this.options.text.text),
                    t
                  );
                },
              },
              {
                ...
                value: function (t) {
                  ...
                  (e += 'left: ' + this.options.x + '%;'),
                    (e += 'top: ' + this.options.y + '%;'),
                    (e +=
                      'font-family: ' + this.options.text.font_family + ';'),
                    (e += 'font-size: ' + this.options.text.font_size + 'px;'),
                    (e +=
                      'font-weight: ' + this.options.text.font_weight + ';'),
                    (e +=
                      'color: rgba(' +
                      n.r +
                      ', ' +
      ...
      971: (
        ...
        var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_6__ =
          ...
          Editor_scripts_utilities__WEBPACK_IMPORTED_MODULE_0__ =
            __webpack_require__(9997),
          Client_consts__WEBPACK_IMPORTED_MODULE_12__ =
            __webpack_require__(4957),
          Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_8__ =
            __webpack_require__(144),
          Client_UI_objects_spot__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(1309),
          Client_UI_objects_text__WEBPACK_IMPORTED_MODULE_2__ =
            __webpack_require__(9586),
          Client_UI_objects_rect__WEBPACK_IMPORTED_MODULE_3__ =
            __webpack_require__(4920),
          Client_UI_objects_oval__WEBPACK_IMPORTED_MODULE_4__ =
            __webpack_require__(3881),
          Client_UI_objects_poly__WEBPACK_IMPORTED_MODULE_5__ =
            __webpack_require__(1350),
          Client_UI_objects_group__WEBPACK_IMPORTED_MODULE_11__ =
            __webpack_require__(3894),
          Client_UI_objects_svgSingle__WEBPACK_IMPORTED_MODULE_10__ =
            __webpack_require__(6856),
          Client_UI_objects_svg__WEBPACK_IMPORTED_MODULE_9__ =
        ...
        var ObjectController = (function () {
          function ObjectController(t) {
            ...
            _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_6__.Z)(
              ...
              (this.stylesheet.className = 'viewer-styles');
            this.stylesheet.className = 'viewer-styles-two';
            this.setupContainers(), this.createObjects(), this.insertObjects();
          }
          return (
            (0,
              ...
              [
                ...
                },
                {
                  ...
                  value: function (t) {
                    if (
                      'zoomUpdate' === t.type &&
                      this.store.state.objectConfig.scale_spots
                    ) {
                      var e,
                      ...
                      try {
                        for (n.s(); !(e = n.n()).done; ) {
                          var o = e.value;
                          o.options.type ===
                            Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_8__.dv &&
                      ...
                      for (e.s(); !(t = e.n()).done; ) {
                        ...
                        switch (n.type) {
                          case Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_8__.dv:
                            (this.objects[n.id] =
                              new Client_UI_objects_spot__WEBPACK_IMPORTED_MODULE_1__.Z(
                                n,
                                this.store
                              )),
                          ...
                          case Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_8__.tk:
                            this.objects[n.id] =
                              new Client_UI_objects_text__WEBPACK_IMPORTED_MODULE_2__.Z(
                                n,
                                this.store
                              );
                            break;
                          case Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_8__.Uv:
                            this.objects[n.id] =
                              new Client_UI_objects_rect__WEBPACK_IMPORTED_MODULE_3__.Z(
                                n,
                                this.store
                              );
                            break;
                          case Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_8__.CW:
                            this.objects[n.id] =
                              new Client_UI_objects_oval__WEBPACK_IMPORTED_MODULE_4__.Z(
                                n,
                                this.store
                              );
                            break;
                          case Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_8__.zJ:
                            this.objects[n.id] =
                              new Client_UI_objects_poly__WEBPACK_IMPORTED_MODULE_5__.Z(
                                n,
                                this.store
                              );
                            break;
                          case Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_8__._9:
                            this.objects[n.id] =
                              new Client_UI_objects_svg__WEBPACK_IMPORTED_MODULE_9__.Z(
                                n,
                                this.store
                              );
                            break;
                          case Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_8__.Le:
                            this.objects[n.id] =
                              new Client_UI_objects_svgSingle__WEBPACK_IMPORTED_MODULE_10__.Z(
                                n,
                                this.store
                              );
                            break;
                          case Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_8__.WW:
                            this.objects[n.id] =
                              new Client_UI_objects_group__WEBPACK_IMPORTED_MODULE_11__.Z(
                                n,
                                this.store
                              );
                        }
                ...
                },
                {
                  ...
                  value: function () {
                    this.container.classList.add('imp-objects'),
                      this.imageBackgroundsContainer.classList.add(
                      ...
                      this.stylesheet.setAttribute(
                        'id',
                        'stylesheet-'.concat(this.store.getID())
                      ),
                  ...
                  value: function () {
                    var t,
                      e = _createForOfIteratorHelper(
                        Object.keys(this.objects).reverse()
                      );
                    try {
                      for (e.s(); !(t = e.n()).done; ) {
                        var n = t.value;
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    if (this.store.state.objectConfig.glowing_objects) {
                      var n = (0,
                      Editor_scripts_utilities__WEBPACK_IMPORTED_MODULE_0__.oo)(
                      ...
                      (t += '@keyframes ObjectGlowAnimation {'),
                        ...
                        (t += '    filter: drop-shadow(0 0 20px rgba('
                          ...
                          .concat(n.b, ', ')
                          .concat(
                            this.store.state.objectConfig.glow_opacity,
                            '));'
                          )),
                        (t += '  }'),
                        (t += '  50% {'),
                    ...
                    if (
                      ...
                      this.store.getObjects().length > 20 &&
                        ...
                        Object.keys(this.objects).forEach(function (e) {
                          t.objects[e].options.static ||
                            t.objects[e].element.classList.add(
                              'imp-object-pageload-animation'
                            );
                        }),
                        setTimeout(function () {
                          var e = 0;
                          for (var o in t.objects)
                            t.objects[o].options.static ||
                              (t.animateObject(t.objects[o], n * e), e++);
                        }, e);
                    }
                  },
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    if (
                      t.options.type !==
                        Editor_scripts_consts__WEBPACK_IMPORTED_MODULE_8__.WW ||
                      t.options.single_object
                    ) {
                      var o = 0;
                      setTimeout(function () {
                        'fade' ===
                          n.store.state.objectConfig.pageload_animation &&
                          ((t.element.style.opacity =
                            t.options.default_style.opacity),
                          setTimeout(function () {
                    ...
                    function i() {
                      window.requestAnimationFrame(function () {
                        o += 0.01666;
                        var e = (0,
                        Editor_scripts_utilities__WEBPACK_IMPORTED_MODULE_0__.C6)(
                          void 0,
                          o,
                          -200,
                          200,
                        ...
                        (t.element.style.transform = 'translateY('.concat(
                          e,
                          'px)'
                        )),
                          o <= 2 && i();
                      ...
                      e.store.state.objectConfig.glowing_objects &&
                        ...
                        e.objects[t] &&
                          ...
                          (e.objects[t].getHighlightIds().forEach(function (t) {
                            e.objects[t].highlight(),
                              e.highlightedObjects.add(t);
                          }),
                          ImageMapPro.trigger({
                            type: Client_consts__WEBPACK_IMPORTED_MODULE_12__.Y7,
                            payload: {
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    return new Promise(function (n) {
                      e.objects[t].getHighlightIds().forEach(function (t) {
                        e.objects[t].unhighlight(),
                          e.highlightedObjects.delete(t);
                      }),
                        ImageMapPro.trigger({
                          type: Client_consts__WEBPACK_IMPORTED_MODULE_12__.JA,
                          payload: {
                            map: e.store.state.general.name,
                            object: e.objects[t].options.title,
                          },
                ...
                },
                {
                  ...
                  value: function performClickAction(id) {
                    (id = this.store.getObject({ id }).parent || id),
                      this.objects[id] &&
                        ('follow-link' ===
                          this.objects[id].options.actions.click &&
                          (document.querySelector('#imp-temp-link') ||
                            document.body.appendChild(
                              (0,
                              Editor_scripts_utilities__WEBPACK_IMPORTED_MODULE_0__.Bv)(
                          ...
                          document
                            ...
                            .setAttribute(
                              'href',
                              this.objects[id].options.actions.link
                            ),
                          this.objects[id].options.actions
                        ...
                        'run-script' ===
                          this.objects[id].options.actions.click &&
                          eval(
                            this.objects[id].options.actions.script.replace(
                              '<br>',
                              ''
                            )
                          ),
                        'change-artboard' ===
                          ...
                          this.store.dispatch('changeArtboard', {
                            artboardId:
                              this.objects[id].options.actions.artboard,
                            zoomOut: !0,
                          }),
                        ImageMapPro.trigger({
                          type: Client_consts__WEBPACK_IMPORTED_MODULE_12__.x4,
                          payload: {
                            map: this.store.state.general.name,
                            object: this.objects[id].options.id,
                          },
                        }));
                  },
                },
      ...
      9997: (t, e, n) => {
        ...
        var o = n(1002),
          ...
          l = function (t) {
            if (
              ...
              return {
                width: parseFloat(
                  getComputedStyle(t, null).width.replace('px', '')
                ),
                height: parseFloat(
                ...
                position: {
                  left: parseFloat(t.offsetLeft),
                  top: parseFloat(t.offsetTop),
                },
              };
          },
          u = function (t) {
        ...
        (m.prototype.add = function (t) {
          ...
          (m.prototype.closestPointOnLine = function (t, e) {
            ...
            var i =
              ((this.x - t.x) * (e.x - t.x) + (this.y - t.y) * (e.y - t.y)) / o;
            return i < 0
              ? t
              : i > 1
              ? e
              : new m(t.x + i * (e.x - t.x), t.y + i * (e.y - t.y));
          }),
          ...
          function j(t, e, n) {
            ...
            return function (i, r) {
              ...
              for (n.method = i, n.arg = r; ; ) {
                ...
                if ('normal' === c.type) {
                  if (
                    ((o = n.done ? 'completed' : 'suspendedYield'), c.arg === m)
                  )
                    continue;
      ...
      3930: (t, e, n) => {
        ...
        var o = n(1002);
        function i(t, e) {
          if (e && ('object' === (0, o.Z)(e) || 'function' == typeof e))
            return e;
          if (void 0 !== e)
            throw new TypeError(
  ...
  (() => {
    ...
    window.ImageMapPro.subscribe(function (t) {
      ...
      e &&
        (t.type == g.HW &&
          (null === (n = e.imageMapProInitialized) ||
            void 0 === n ||
            n.call(b, t.payload.map)),
        t.type == g.Y7 &&
        ...
        t.type == g.ly &&
          (null === (a = e.imageMapProEventOpenedTooltip) ||
            void 0 === a ||
            a.call(b, t.payload.map, t.payload.id)),
        t.type == g.x_ &&
                ...
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      if (
                        ...
                        (i =
                          ...
                          ImageMapPro.instances[
                            Object.keys(ImageMapPro.instances)[0]
                          ]))
                      ) {
                        t.next = 5;
                        break;
                    ...
                    case 11:
                      return (
                        (t.next = 13),
                        i.store.dispatch('changeArtboard', {
                          artboardId: a,
                          zoomOut: !0,
                        })
                      );
            ...
            for (;;)
              switch ((t.prev = t.next)) {
                ...
                case 9:
                  return (
                    (t.next = 11),
                    o.store.dispatch('changeArtboard', {
                      artboardId: r,
                      zoomOut: !0,
                    })
                  );
      ...
      (0, m.Cd)(function () {
        ImageMapPro.subscribe(function (t) {
          'mapInit' == t.type &&
            ...
            document
              .querySelectorAll('[data-imp-highlight-object-on-click]')
              .forEach(function (t) {
            ...
            document
              .querySelectorAll('[data-imp-show-tooltip-on-mouseover]')
              .forEach(function (t) {
            ...
            document
              .querySelectorAll('[data-imp-show-tooltip-on-click]')
              .forEach(function (t) {
                t.addEventListener('click', H);
              }),
            document
              .querySelectorAll('[data-imp-hide-tooltip-on-mouseover]')
              .forEach(function (t) {
                t.addEventListener('mouseover', W);
              }),
            document
              .querySelectorAll('[data-imp-hide-tooltip-on-click]')
              .forEach(function (t) {
            ...
            document
              .querySelectorAll('[data-imp-trigger-object-on-click]')
              .forEach(function (t) {
            ...
            document
              .querySelectorAll('[data-imp-untrigger-object-on-click]')
              .forEach(function (t) {
                t.addEventListener('click', ot);
              }),
            document
              .querySelectorAll('[data-imp-focus-object-on-mouseover]')
              .forEach(function (t) {
                t.addEventListener('mouseover', rt);
              }),
            document
              .querySelectorAll('[data-imp-focus-object-on-click]')
              .forEach(function (t) {
                t.addEventListener('click', st);
              }),
            document
              .querySelectorAll('[data-imp-change-artboard]')
              .forEach(function (t) {
            ...
            document
              ...
              .forEach(function (t) {
                (t.dataset.impHighlightObjectOnMouseover =
                  t.dataset.impHighlightShapeOnMouseover),
                  t.addEventListener('mouseover', E);
              }),
            document
              .querySelectorAll('[data-imp-highlight-shape-on-mouseover]')
            ...
            document
              .querySelectorAll('[data-imp-highlight-shape-on-click]')
              .forEach(function (t) {
                (t.dataset.impHighlightObjectOnClick =
                  t.dataset.impHighlightShapeOnClick),
                  t.addEventListener('click', S);
              }),
            document
              .querySelectorAll('[data-imp-unhighlight-shape-on-click]')
              .forEach(function (t) {
                (t.dataset.impUnhighlightObjectOnClick =
                  t.dataset.impUnhighlightShapeOnClick),
                  t.addEventListener('click', L);
              }),
            document
              .querySelectorAll('[data-imp-open-tooltip-on-mouseover]')
              .forEach(function (t) {
                (t.dataset.impShowTooltipOnMouseover =
                  t.dataset.impOpenTooltipOnMouseover),
                  t.addEventListener('mouseover', U);
              }),
            document
              .querySelectorAll('[data-imp-open-tooltip-on-mouseover]')
            ...
            document
              .querySelectorAll('[data-imp-open-tooltip-on-click]')
              .forEach(function (t) {
                (t.dataset.impShowTooltipOnClick =
                  t.dataset.impOpenTooltipOnClick),
                  t.addEventListener('click', H);
              }),
            document
              .querySelectorAll('[data-imp-close-tooltip-on-mouseover]')
              .forEach(function (t) {
                (t.dataset.impHideTooltipOnMouseover =
                  t.dataset.impCloseTooltipOnMouseover),
                  t.addEventListener('mouseover', W);
              }),
            document
              .querySelectorAll('[data-imp-close-tooltip-on-click]')
              .forEach(function (t) {
                (t.dataset.impHideTooltipOnClick =
                  t.dataset.impCloseTooltipOnClick),
                  t.addEventListener('click', N);
              }),
            document
              .querySelectorAll('[data-imp-trigger-shape-on-mouseover]')
              .forEach(function (t) {
                (t.dataset.impTriggerObjectOnMouseover =
                  t.dataset.impTriggerShapeOnMouseover),
                  t.addEventListener('mouseover', K);
              }),
            document
              .querySelectorAll('[data-imp-trigger-shape-on-mouseover]')
            ...
            document
              .querySelectorAll('[data-imp-trigger-shape-on-click]')
              .forEach(function (t) {
                (t.dataset.impTriggerObjectOnClick =
                  t.dataset.impTriggerShapeOnClick),
                  t.addEventListener('click', et);
              }),
            document
              .querySelectorAll('[data-imp-untrigger-shape-on-mouseover]')
              .forEach(function (t) {
                (t.dataset.impUntriggerObjectOnMouseover =
                  t.dataset.impUntriggerShapeOnMouseover),
                  t.addEventListener('mouseover', Q);
              }),
            document
              .querySelectorAll('[data-imp-untrigger-shape-on-click]')
              .forEach(function (t) {
                (t.dataset.impUntriggerObjectOnClick =
                  t.dataset.impUntriggerShapeOnClick),
                  t.addEventListener('click', ot);
              }),
            document
              .querySelectorAll('[data-imp-focus-shape-on-mouseover]')
              .forEach(function (t) {
                (t.dataset.impFocusObjectOnMouseover =
                  t.dataset.impFocusShapeOnMouseover),
                  t.addEventListener('mouseover', rt);
              }),
            document
              .querySelectorAll('[data-imp-focus-shape-on-click]')
              .forEach(function (t) {
                (t.dataset.impFocusObjectOnClick =
                  t.dataset.impFocusShapeOnClick),
                  t.addEventListener('click', st);
              }),
            document
              .querySelectorAll('[data-imp-go-to-floor]')
              .forEach(function (t) {
        ...
        return (
          (0, dt.Z)(t, [
            ...
            },
            {
              ...
              value: function () {
                (this.boundHandleEventStart = this.handleEventStart.bind(this)),
                  ...
                  (this.boundHandleEventKeyDown =
                    this.handleEventKeyDown.bind(this)),
                  (this.boundHandleEventKeyUp =
                    this.handleEventKeyUp.bind(this)),
                  (this.boundHandleEventResize =
                    this.handleEventResize.bind(this)),
                  (this.boundHandleEventWheel =
                    this.handleEventWheel.bind(this)),
                  (this.boundHandleEventChange =
                    this.handleEventChange.bind(this)),
                  (0, m.tq)()
                    ? (document.addEventListener(
                        'touchstart',
                        this.boundHandleEventStart,
                        { passive: !1 }
                      ),
                      document.addEventListener(
                        'touchmove',
                        this.boundHandleEventMove,
                        { passive: !1 }
                      ),
                      document.addEventListener(
                        'touchend',
                        this.boundHandleEventEnd,
                        { passive: !1 }
                      ))
                    : (document.addEventListener(
                        'mousedown',
                  ...
                  this.UIRectUnderEvent ||
                    (this.isEventOverCanvas &&
                      ...
                      (this.store.state.zooming.hold_ctrl_to_zoom
                        ? (this.mac && this.cmdKeyDown) ||
                          (!this.mac && this.ctrlKeyDown)
                          ? this.doZoom(t)
            ...
            },
            {
              ...
              value: function (t) {
                t.target.classList.contains('imp-ui-layers-select') &&
                  t.target.closest(
                    '[data-image-map-id="'.concat(this.store.getID(), '"]')
                  ) &&
                  this.store.dispatch('changeArtboard', {
            ...
            },
            {
              ...
              value: function (t) {
                if ('keydown' == t.type || 'keyup' == t.type)
                  return (
                    (this.ctrlKeyDown = t.ctrlKey),
                    void (this.cmdKeyDown = t.metaKey)
                  );
                (this.eventCoordinates = (0, m.DC)(t)),
                  ...
                  (this.UIClickedRect =
                    this.UIRectUnderEvent === this.UIRectUnderEventStart &&
                    this.UIRectUnderEvent),
                  (this.menuListItemIDUnderEvent =
                    this.getMenuListItemIdUnderEvent(t)),
            ...
            },
            {
              ...
              value: function (t) {
                return (
                  this.actionStart === g.Nb &&
                    ((this.action = g.Nb),
                    this.store.dispatch('startPinch', { event: t })),
                  ...
                  this.action === g.Nb
                    ? (this.store.dispatch('pinch', { event: t }),
              ...
              value: function (t) {
                if (this.UIClickedRect) {
                  if (
                    ...
                    this.UIClickedRect === g.f9 &&
                      this.store.dispatch('zoomIn', {}),
                    this.UIClickedRect === g.s2 &&
                      ...
                      function (t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 3:
                              if (
                                !this.store.getImageMap().config.zooming
                                  .zoom_on_object_click
                              ) {
                                t.next = 6;
                                break;
                              }
                      ...
                      function (t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            case 0:
                              if (
                                !this.store.getTooltipController()
                                  .stickyTooltips ||
                                !this.isEventOverTooltip ||
                                this.store.getAreTooltipsFullscreen()
                              ) {
                            ...
                            case 6:
                              if (
                                this.objectIdUnderEventPrevious !==
                                this.objectIdUnderEvent
                              ) {
                                t.next = 8;
                                break;
                            ...
                            case 12:
                              return (
                                (n = !0),
                                'click' ==
                                  this.store.state.tooltips.show_tooltips &&
                                  (n = !1),
                                this.store.dispatch('highlightObject', {
                                  objectId: this.objectIdUnderEvent,
                                  showTooltip: n,
            ...
            },
            {
              ...
              value: function (t) {
                return (
                  this.menuListItemIDUnderEventPrevious !==
                    this.menuListItemIDUnderEvent &&
                      ...
                      function (t) {
                        for (;;)
                          switch ((t.prev = t.next)) {
                            ...
                            case 23:
                              return (
                                this.preventDefault(e), t.abrupt('return', !0)
                              );
                            case 25:
                              return t.abrupt('return', !1);
                            case 26:
              ...
              value: function () {
                for (var t in this.UIRects)
                  if (
                    ...
                    return (this.UIRectUnderEvent = t), t;
                return !1;
              },
            },
            {
            ...
            },
            {
              ...
              value: function (t) {
                ...
                if (
                  (t.target.dataset.parentId
                    ...
                    : null !== (e = t.target.closest('[data-parent-id]')) &&
                      ...
                      e.dataset.parentId
                    ? (a =
                        null === (n = t.target.closest('[data-parent-id]')) ||
                        void 0 === n
                          ? void 0
                          : n.dataset.parentId)
                    ...
                    : null !== (o = t.target.closest('[data-object-id]')) &&
                      ...
                      o.dataset.objectId &&
                      (a =
                        null === (i = t.target.closest('[data-object-id]')) ||
                        void 0 === i
                          ? void 0
                          : i.dataset.objectId),
                  !a)
                ...
                var s =
                  ...
                  (null === (r = t.target.closest('[data-image-map-id]')) ||
                  void 0 === r
                    ? void 0
            ...
            },
            {
              ...
              value: function (t) {
                if (
                  t.target.classList.contains('imp-tooltip') ||
                  t.target.closest('.imp-tooltip')
                )
                  return !0;
              },
            },
              ...
              value: function (t) {
                ...
                return (
                  !(
                    ...
                    !t.target.closest('[data-list-item-id]')
                  ) &&
                  (t.target.dataset.imageMapId ||
                    t.target.closest('[data-list-item-id]').dataset
                      .imageMapId) === this.store.getID() &&
                  (t.target.dataset.listItemId ||
                    (null === (e = t.target.closest('[data-list-item-id]')) ||
                    void 0 === e
                      ? void 0
        ...
        return (
          (0, dt.Z)(t, [
            ...
            },
            {
              key: 'html',
              value: function () {
                return '<div data-imp-id="'
                  .concat(
                    this.mapID,
                    '" data-element-name="fullscreenButton" style="'
                  )
                  .concat(
                    this.css(),
            ...
            },
            {
              ...
              value: function () {
                ...
                (n.general.name += ' [fullscreen]'),
                  (n.id += ' [fullscreen]'),
                  null ===
                    (t = document.querySelector('#imp-fullscreen-container')) ||
                    void 0 === t ||
                    t.remove(),
                  document.body.appendChild(
                    (0, m.Bv)(
          ...
          (0, dt.Z)(t, [
            {
              ...
              value: function () {
                var t =
                  '<div class="imp-ui-element imp-ui-navigator-root" data-element-name="navigator" data-imp-id='.concat(
                    this.store.getID(),
                    '>'
                  );
                return (
                  ...
                  'color' === this.store.getArtboard().background_type &&
                    ((t +=
                      '<div class="imp-ui-navigator-window-image" style="background: '.concat(
                    ...
                    (t +=
                      '<div class="imp-ui-navigator-background" style="background: '.concat(
                        this.store.getArtboard().background_color,
                        '"></div>'
                      ))),
              ...
              value: function () {
                ...
                t >= 1
                  ? ((this.window.width = 150),
                    (this.window.height = this.window.width / t))
                  : ((this.window.height = 150),
                    (this.window.width = this.window.height * t)),
          ...
          (0, dt.Z)(t, [
            {
              ...
              value: function () {
                this.store.state.zooming.enable_zooming &&
                  ...
                  (this.navigator = new wt(this.store)));
              },
            },
            {
              key: 'insertUI',
            ...
            },
            {
              ...
              value: function (t) {
                ...
                'resize' == t.type &&
                  ...
                  'panOnNavigator' == t.type &&
                    this.pan({ x: t.payload.x, y: t.payload.y }),
            ...
            },
            {
              ...
              value: function (t) {
                var e = t.x,
                  n = t.y,
                  o =
                    ((e - this.store.getNavigatorRect().offset.left) /
                      this.navigator.ratio) *
                    this.store.getZoom(),
                  i =
                    ((n - this.store.getNavigatorRect().offset.top) /
                      this.navigator.ratio) *
                    this.store.getZoom();
          ...
          (0, dt.Z)(t, [
            {
              ...
              value: function () {
                return '\n    font-family: '
                  ...
                  .concat(
                    this.options.boxModel.margin.top,
                    'px;\n    margin-bottom: '
                  )
                  .concat(
                    this.options.boxModel.margin.bottom,
                    'px;\n    margin-left: '
                  )
                  .concat(
                    this.options.boxModel.margin.left,
                    'px;\n    margin-right: '
                  )
                  .concat(
                    this.options.boxModel.margin.right,
                    'px;\n\n    padding-top: '
                  )
                  .concat(
                    this.options.boxModel.padding.top,
                    'px;\n    padding-bottom: '
                  )
                  .concat(
                    this.options.boxModel.padding.bottom,
                    'px;\n    padding-left: '
                  )
                  .concat(
                    this.options.boxModel.padding.left,
                    'px;\n    padding-right: '
                  )
          ...
          (0, dt.Z)(t, [
            {
              ...
              value: function () {
                return '\n    background-color: '
                  .concat(
                    this.options.style.backgroundColor,
                    ';\n    border-radius: '
                  )
                  .concat(
                    this.options.style.borderRadius,
                    'px;\n\n    font-family: '
                  )
                  .concat(this.options.style.fontFamily, ';\n    font-weight: ')
            ...
            },
            {
              ...
              value: function () {
                ...
                var e = '<video '
                  ...
                  .concat(this.options.other.classes, '">\n\n    <source src="')
                  .concat(
                    this.options.src.mp4,
                    '" type="video/mp4">\n    <source src="'
                  )
                  .concat(
                    this.options.src.webm,
                    '" type="video/webm">\n    <source src="'
                  )
                  .concat(
                    this.options.src.ogv,
                    '" type="video/ogv">\n    \n    </video>'
                  );
                return (
          ...
          (0, dt.Z)(t, [
            {
              ...
              value: function () {
                var t = '',
                  e = (0, m.oo)(this.style.background_color) || {
                    r: 0,
                    b: 0,
                    g: 0,
                  };
                return (
                  (t += 'border-radius: '.concat(
                  ...
                  this.style.auto_width ||
                    (t += 'width: '.concat(this.style.width, 'px;')),
                  t
                );
              },
            },
            {
              ...
              value: function () {
                ...
                return (
                  (t +=
                    '<div class="imp-tooltip-wrap imp-tooltip-position-'.concat(
                      this.style.position,
                      '">'
                    )),
                  ...
                  'right' === this.style.position &&
                    (t +=
                      '<div class="hs-arrow hs-arrow-left" style="border-right-color: rgba('
                        ...
                        .concat(e.b, ', ')
                        .concat(this.style.background_opacity, ');"></div>')),
                  (t += '<div class="imp-tooltip-content">'.concat(
                    this.content.html(),
                    '</div>'
                  )),
                  (t += '</div>'),
          ...
          (0, dt.Z)(t, [
            ...
            },
            {
              ...
              value: function () {
                var t = '';
                return (t +=
                  ' <div class="imp-fullscreen-tooltip" data-tooltip-id="'
                    .concat(
                      this.id,
    ...
    var Wt = (function () {
          ...
          (0, pt.Z)(this, t),
            ...
            this.store.state.tooltips.enable_tooltips &&
              ...
              ('always' === this.store.state.tooltips.fullscreen_tooltips ||
                ('mobile-only' ===
                  this.store.state.tooltips.fullscreen_tooltips &&
                  (0, m.tq)())) &&
          ...
          (0, dt.Z)(t, [
            ...
            },
            {
              ...
              value: function () {
                ...
                if (
                  ...
                  var e = (0, m.oo)(
                    this.store.state.tooltips.fullscreen_background
                  ) || { r: 0, b: 0, g: 0 };
                  this.container.style.background = 'rgba('
                    ...
                    .concat(e.b, ', ')
                    .concat(
                      this.store.state.tooltips.fullscreen_background_opacity,
                      ')'
                    );
                }
              },
                ...
                try {
                  for (n.s(); !(t = n.n()).done; ) {
                    ...
                    if (
                      ...
                      o.tooltip.enable_tooltip && o.type !== jt.tk)
                    ) {
                      var i = void 0;
                          ...
                          return w().wrap(function (n) {
                            for (;;)
                              switch ((n.prev = n.next)) {
                                case 0:
                                  if (
                                    (i = e.store.getObject({ id: t })).tooltip
                                      .enable_tooltip
                                  ) {
                                    n.next = 4;
                                    break;
                                ...
                                case 10:
                                  e.openedTooltips.add(t),
                                    ('mobile-only' ===
                                      e.store.state.tooltips
                                        .fullscreen_tooltips &&
                                      (0, m.tq)()) ||
                                    'always' ===
                                      e.store.state.tooltips.fullscreen_tooltips
                                      ? (e.animateFullscreenTooltipIn(t),
                                        requestAnimationFrame(o))
                                      : ((r = e.getTooltipElement(t)),
                                        clearTimeout(
                                          e.tooltipAnimationTimeouts[t]
                                        ),
              ...
              value: function (t) {
                ...
                return (
                  ...
                  new Promise(function (n) {
                    e.store.getObject({ id: t }).type !== jt.tk &&
                    e.openedTooltips.has(t)
                      ? (e.openedTooltips.delete(t),
                        ('mobile-only' ===
                          e.store.state.tooltips.fullscreen_tooltips &&
                          (0, m.tq)()) ||
                        'always' === e.store.state.tooltips.fullscreen_tooltips
                          ? (e.animateFullscreenTooltipOut(t),
                            requestAnimationFrame(n))
                ...
                if (!this.store.state.tooltips.sticky_tooltips)
                  return 'grow' === this.store.state.tooltips.tooltip_animation
                    ? ((e.style.transitionProperty = 'none'),
                      ...
                      void (this.tooltipAnimationTimeouts[t] =
                        requestAnimationFrame(function () {
              ...
              value: function (t) {
                ...
                return (
                  ...
                  this.store.state.tooltips.sticky_tooltips
                    ...
                    ? ((e.style.transform = 'scale(0, 0)'),
                      clearTimeout(this.tooltipAnimationTimeouts[t]),
                      void (this.tooltipAnimationTimeouts[t] = setTimeout(
                        function () {
            ...
            },
            {
              ...
              value: function (t) {
                ...
                (this.container.style.opacity = 0),
                  ...
                  (this.tooltipAnimationTimeouts[t + '-container'] = setTimeout(
                    function () {
            ...
            },
            {
              ...
              value: function (t) {
                ...
                var e = this.store
                    .getObjectController()
                    .objects[t].getBoundingClientRect(),
                ...
                return (
                  'top' ===
                    this.store.getObject({ id: t }).tooltip_style.position &&
                    ((l = [
                      [r, a],
                      [r + s, a],
                      [r + s, a + c],
                  ...
                  if (
                    (this.stickyTooltips
                      ...
                      : ((o =
                        ...
                        (e =
                          (a.x / 100) * this.store.getCanvasWrapRect().width),
                        (n =
                          (a.y / 100) * this.store.getCanvasWrapRect().height),
      ...
      qt = (function () {
        function t(e) {
          ...
          (0, pt.Z)(this, t),
            mt(this, 'id', void 0),
            mt(this, 'textColor', void 0),
            mt(this, 'backgroundColor', void 0),
            mt(this, 'zoomInButton', void 0),
            mt(this, 'zoomOutButton', void 0),
            (this.id = n),
            this.createElements();
        }
        return (
          ...
          (0, dt.Z)(t, [
            {
              ...
              value: function (t) {
                'failedToZoom' == t.type && this.displayScrollMessage(),
                  'panTo' == t.type &&
                    this.setTargetPan({ x: t.payload.x, y: t.payload.y }),
                  'startPan' == t.type &&
                    this.startPan({ x: t.payload.x, y: t.payload.y }),
                  'pan' == t.type &&
                    this.pan({ x: t.payload.x, y: t.payload.y }),
              ...
              value: function (t) {
                (this.pinchInitial[0] = {
                  ...
                  (this.pinchInitialDistance = Math.sqrt(
                    Math.pow(
                      this.pinchInitial[1].x - this.pinchInitial[0].x,
                      2
                    ) +
                      Math.pow(
                        this.pinchInitial[1].y - this.pinchInitial[0].y,
                        2
                      )
                  )),
            ...
            },
            {
              ...
              value: function () {
                this.store.state.zooming.enable_zooming || (this.maxZoom = 1),
                  this.store.getImage() &&
                  this.store.state.zooming.limit_max_zoom_to_image_size
                    ? (this.maxZoom =
                        this.store.getImage().naturalWidth /
                        this.store.getCanvasWrapRect().width)
            ...
            },
            {
              ...
              value: function () {
                (this.minPanX =
                  ...
                  this.targetPanX < this.minPanX &&
                    (this.targetPanX = this.minPanX),
                  this.targetPanY < this.minPanY &&
                    (this.targetPanY = this.minPanY);
              },
            },
            {
              ...
              value: function (t) {
                t
                  ? ((this.currentZoom = (0, m.t7)(
                      this.currentZoom,
                      this.targetZoom,
                      0.1
                    )),
                    (this.actualPanX = (0, m.t7)(
                      this.actualPanX,
                      this.targetPanX,
                      0.1
                    )),
                    (this.actualPanY = (0, m.t7)(
                      this.actualPanY,
                      this.targetPanY,
                      0.1
                    )),
          ...
          (0, dt.Z)(t, [
            {
              ...
              value: function () {
                var t = '';
                (t +=
                  '<div class="imp-ui-layers-menu-wrap" data-element-name="layersSelect">'),
                  (t += vt),
                  (t +=
      ...
      Kt = (function () {
        function t(e, n) {
          (0, pt.Z)(this, t),
            ...
            this.store.state.artboards.length > 1
              ? ((this.artboardMenu = new Xt(this.store)),
        ...
        return (
          (0, dt.Z)(t, [
            ...
            },
            {
              ...
              value: function () {
                this.visible &&
                  this.element.classList.remove('imp-object-list-item-hidden'),
                  this.visible ||
                    this.element.classList.add('imp-object-list-item-hidden');
              },
            },
          ]),
          t
                ...
                try {
                  var o = function () {
                    ...
                    if (t.store.state.object_list.group_by_artboard) {
                      var r = new Gt({ options: o, mapId: t.store.getID() });
                    ...
                    o.children.forEach(function (e) {
                      a.push.apply(
                        a,
                        (0, Vt.Z)(t.createItemAndChildren(e, [o.id]))
                      );
                    }),
              ...
              value: function (t) {
                var e =
                  arguments.length > 1 && void 0 !== arguments[1]
                    ...
                    : [];
                if (
                  this.store.state.object_list.hide_static_objects &&
                  t.static
                )
                  return [];
                var n = [],
                  ...
                  try {
                    for (a.s(); !(r = a.n()).done; ) {
                      ...
                      if (
                        ...
                        var c = this.createItemAndChildren(
                          s,
                          [].concat((0, Vt.Z)(e), [t.id])
                        );
                ...
                return (
                  (this.parentsForItem[t.id] = this.parentsForItem[t.id]
                    ? [].concat(
                        (0, Vt.Z)(this.parentsForItem[t.id]),
                        (0, Vt.Z)(e)
                      )
                    : e),
                  n
                ...
                try {
                  for (n.s(); !(t = n.n()).done; ) {
                    ...
                    if (e.length > 2) {
                      ...
                      o.options.title != r
                        ? (o.show(),
                          (o.element.querySelector('p').innerHTML = r))
                        : (o.hide(),
                          (o.element.querySelector('p').innerHTML =
                            o.options.title));
                    } else
                      o.show(),
                        (o.element.querySelector('p').innerHTML =
            ...
            },
            {
              ...
              value: function (t) {
                this.hiddenArtboards.has(t)
                  ? (this.hiddenArtboards.delete(t),
                    this.artboardItems[t].expand())
                  : (this.hiddenArtboards.add(t),
                    this.artboardItems[t].collapse()),
                  this.render();
              },
            },
            {
                  ...
                  for (e.s(); !(t = e.n()).done; ) {
                    ...
                    try {
                      for (r.s(); !(n = r.n()).done; ) {
                        var a = n.value;
                        if (
                          this.hiddenGroups.has(a) ||
                          this.hiddenArtboards.has(a)
                        ) {
                          i = !0;
                          break;
                        }
          ...
          (0, dt.Z)(t, [
            {
              ...
              value: function () {
                return '\n      <div class="imp-search-box">\n        <div class="imp-search-box-input-wrap">\n          <input type="text" placeholder="Search...">\n          '
                  ...
                  .concat(
                    bt.replace('imp-icon', 'imp-icon imp-clear-search'),
                    '\n        </div>\n      </div>'
                  );
              },
            },
        ...
        function t(e) {
          (0, pt.Z)(this, t),
            ...
            'on-top' != this.store.state.object_list.menu_style ||
              ...
              this.store
                .getContainer()
                .classList.add('imp-object-menu-on-top-left'),
            'on-top' != this.store.state.object_list.menu_style ||
              this.store.getIsMenuMobile() ||
              'right' != this.store.state.object_list.menu_position ||
              this.store
                .getContainer()
                .classList.add('imp-object-menu-on-top-right');
        }
        return (
          (0, dt.Z)(t, [
            {
        ...
        function t(e) {
          (0, pt.Z)(this, t),
            ...
            this.store.state.object_list.enable_object_list &&
              ...
              (this.menu.element.dataset.impId = this.store.getID()),
          ...
          (0, dt.Z)(t, [
              ...
              value: function (t) {
                ...
                'resize' == t.type &&
                  ...
                  'updateSearch' == t.type &&
                    ...
                    this.menu.list.filterItems(t.payload.searchString)),
                  'clearSearch' == t.type &&
            ...
            },
            {
              ...
              value: function () {
                ...
                this.store.getIsMenuMobile()
                  ? (this.menu.element.style.height =
                      this.getMenuHeight() + 'px')
                  : (this.menu.element.style.maxHeight =
                      this.getMenuHeight() + 'px');
              },
            },
            {
              key: 'getMenuHeight',
              value: function () {
                return this.store.getIsFullscreen() ||
                  this.store.getIsMenuMobile()
                  ? window.innerHeight
                  : 'detached' === this.store.state.object_list.menu_style
                  ? 'auto'
    ...
    const ce = {
      ...
      getIsMenuMobile: function () {
        var t =
          parseInt(this.getContainer().getBoundingClientRect().width) ||
          this.getArtboard().width;
        ...
        return (
          this.imageMap.cacheController.getValue(g.ZY) ||
            this.imageMap.cacheController.setValue(
              g.ZY,
              (0, m.Yo)(this.imageMap.canvasWrap)
            ),
          this.imageMap.cacheController.getValue(g.ZY)
        );
      },
      ...
      getOpenedFullscreenTooltipRect: function () {
        var t = this.imageMap.tooltipController.openedTooltips
          .values()
          .next().value;
                    ...
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          ...
                          n
                            .getZoomController()
                            .zoomIn({ coords: o, animate: r, targetZoom: a })
                        );
                      case 2:
                        e();
                      case 3:
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          (t.next = 2),
                          n.getObjectController().highlightObject(o)
                        );
                      case 2:
                        if (!s) {
                          t.next = 5;
                        ...
                        return (
                          (t.next = 5),
                          n.getTooltipController().hideAllTooltips()
                        );
                      case 5:
                        if (!r) {
                          t.next = 8;
                        ...
                        return (
                          (t.next = 8), n.getTooltipController().showTooltip(o)
                        );
                      case 8:
                        e();
                      case 9:
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          (t.next = 2),
                          n.getObjectController().unhighlightObject(o)
                        );
                      case 2:
                        return (
                          (t.next = 4), n.getTooltipController().hideTooltip(o)
                        );
                      case 4:
                        e();
                      case 5:
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          (t.next = 2),
                          e.getObjectController().unhighlightAllObjects()
                        );
                      case 2:
                        return (
                          (t.next = 4),
                          e.getTooltipController().hideAllTooltips()
                        );
                      case 4:
                        n();
                      case 5:
                      ...
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            ...
                            return (
                              (e.next = 3),
                              o.getTooltipController().hideAllTooltips()
                            );
                          case 3:
                            return (
                              (e.next = 5),
                              o.getTooltipController().showTooltip(i)
                            );
                          case 5:
                            t();
                          case 6:
                                  ...
                                  for (;;)
                                    switch ((t.prev = t.next)) {
                                      ...
                                      case 13:
                                        return (
                                          s &&
                                            i.getZoomController().resetZoom(!0),
                                          (t.next = 16),
                                          i
                                            .getTooltipController()
                                            .createTooltips()
                                      ...
                                      case 16:
                                        return (
                                          (t.next = 18),
                                          i.getMenuController().updateItems()
                                        );
                                      case 18:
                                        ImageMapPro.trigger({
                                          type: g.S3,
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          (t.next = 2),
                          n.getMenuController().menu.list.toggleGroup(o)
                        );
                      case 2:
                        e();
                      case 3:
                  ...
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          (t.next = 2),
                          n.getMenuController().menu.list.toggleArtboard(o)
                        );
                      case 2:
                        e();
                      case 3:
                ...
                return w().wrap(function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          (t.next = 2), n.getTooltipController().showTooltip(o)
                        );
                      case 2:
                        e();
                      case 3:
                ...
                return w().wrap(function (t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return (
                          (t.next = 2), n.getTooltipController().hideTooltip(o)
                        );
                      case 2:
                        e();
                      case 3:
      ...
      function t(e) {
        ...
        mt(this, 'getterProxyHandler', {
          apply: function (t, e, n) {
            return (t = t.bind(e)).apply(
              void 0,
              [e.state].concat((0, Vt.Z)(n))
            );
          },
        }),
        (this.imageMap = o),
      ...
      return {
        ...
        other: {
          ...
          classes:
            ...
            void 0 === a
              ? void 0
              : a.classes) || Et.paragraph.other.classes,
          css:
            (null === (s = t.options) ||
            void 0 === s ||
            null === (c = s.general) ||
        ...
        style: {
          fontFamily:
            ...
            void 0 === u
              ? void 0
              : u.font_family) || Et.paragraph.style.fontFamily,
          fontSize:
            (null === (p = t.options) ||
            void 0 === p ||
            null === (d = p.font) ||
            void 0 === d
              ? void 0
              : d.font_size) || Et.paragraph.style.fontSize,
          fontWeight:
            (null === (h = t.options) ||
            void 0 === h ||
            null === (m = h.font) ||
            void 0 === m
              ? void 0
              : m.font_weight) || Et.paragraph.style.fontWeight,
          fontStyle:
            (null === (f = t.options) ||
            void 0 === f ||
            null === (g = f.font) ||
            void 0 === g
              ? void 0
              : g.font_style) || Et.paragraph.style.fontStyle,
          lineHeight:
            (null === (b = t.options) ||
            void 0 === b ||
            null === (v = b.font) ||
            void 0 === v
              ? void 0
              : v.line_height) || Et.paragraph.style.lineHeight,
          color:
            (null === (y = t.options) ||
            void 0 === y ||
            null === (_ = y.font) ||
            void 0 === _
              ? void 0
              : _.text_color) || Et.paragraph.style.color,
          textAlign:
            (null === (w = t.options) ||
            void 0 === w ||
            null === (x = w.font) ||
            void 0 === x
              ? void 0
              : x.text_align) || Et.paragraph.style.textAlign,
          textDecoration:
            (null === (k = t.options) ||
            void 0 === k ||
            null === (j = k.font) ||
            void 0 === j
              ? void 0
              : j.text_decoration) || Et.paragraph.style.textDecoration,
          textTransform:
            (null === (M = t.options) ||
            void 0 === M ||
            null === (I = M.font) ||
            void 0 === I
              ? void 0
              : I.text_transform) || Et.paragraph.style.textTransform,
          textShadow:
            (null === (C = t.options) ||
            void 0 === C ||
            null === (E = C.font) ||
            void 0 === E
              ? void 0
              : E.text_shadow) || Et.paragraph.style.textShadow,
        },
        boxModel: {
          width: 'auto',
          height: 'auto',
          margin: {
            top:
              ...
              void 0 === T
                ? void 0
                : T.top) || Et.paragraph.boxModel.margin.top,
            bottom:
              (null === (z = t.options) ||
              void 0 === z ||
              null === (S = z.layout) ||
              ...
              void 0 === L
                ? void 0
                : L.bottom) || Et.paragraph.boxModel.margin.bottom,
            left:
              (null === (R = t.options) ||
              void 0 === R ||
              null === (U = R.layout) ||
              ...
              void 0 === F
                ? void 0
                : F.left) || Et.paragraph.boxModel.margin.left,
            right:
              (null === (D = t.options) ||
              void 0 === D ||
              null === (W = D.layout) ||
              ...
              void 0 === H
                ? void 0
                : H.right) || Et.paragraph.boxModel.margin.right,
          },
          padding: {
            top:
              (null === (Y = t.options) ||
              ...
              void 0 === K
                ? void 0
                : K.top) || Et.paragraph.boxModel.padding.top,
            bottom:
              (null === (V = t.options) ||
              void 0 === V ||
              null === ($ = V.layout) ||
              ...
              void 0 === J
                ? void 0
                : J.bottom) || Et.paragraph.boxModel.padding.bottom,
            left:
              (null === (Q = t.options) ||
              void 0 === Q ||
              null === (tt = Q.layout) ||
              ...
              void 0 === nt
                ? void 0
                : nt.left) || Et.paragraph.boxModel.padding.left,
            right:
              (null === (ot = t.options) ||
              void 0 === ot ||
              null === (it = ot.layout) ||
              ...
              void 0 === at
                ? void 0
                : at.right) || Et.paragraph.boxModel.padding.right,
          },
        },
      };
    }
      ...
      return {
        ...
        other: {
          ...
          classes:
            ...
            void 0 === c
              ? void 0
              : c.classes) || Et.heading.other.classes,
          css:
            (null === (l = t.options) ||
            void 0 === l ||
            null === (u = l.general) ||
        ...
        style: {
          fontFamily:
            ...
            void 0 === d
              ? void 0
              : d.font_family) || Et.heading.style.fontFamily,
          fontSize:
            (null === (h = t.options) ||
            void 0 === h ||
            null === (m = h.font) ||
            void 0 === m
              ? void 0
              : m.font_size) || Et.heading.style.fontSize,
          fontWeight:
            (null === (f = t.options) ||
            void 0 === f ||
            null === (g = f.font) ||
            void 0 === g
              ? void 0
              : g.font_weight) || Et.heading.style.fontWeight,
          fontStyle:
            (null === (b = t.options) ||
            void 0 === b ||
            null === (v = b.font) ||
            void 0 === v
              ? void 0
              : v.font_style) || Et.heading.style.fontStyle,
          lineHeight:
            (null === (y = t.options) ||
            void 0 === y ||
            null === (_ = y.font) ||
            void 0 === _
              ? void 0
              : _.line_height) || Et.heading.style.lineHeight,
          color:
            (null === (w = t.options) ||
            void 0 === w ||
            null === (x = w.font) ||
            void 0 === x
              ? void 0
              : x.text_color) || Et.heading.style.color,
          textAlign:
            (null === (k = t.options) ||
            void 0 === k ||
            null === (j = k.font) ||
            void 0 === j
              ? void 0
              : j.text_align) || Et.heading.style.textAlign,
          textDecoration:
            (null === (M = t.options) ||
            void 0 === M ||
            null === (I = M.font) ||
            void 0 === I
              ? void 0
              : I.text_decoration) || Et.heading.style.textDecoration,
          textTransform:
            (null === (C = t.options) ||
            void 0 === C ||
            null === (E = C.font) ||
            void 0 === E
              ? void 0
              : E.text_transform) || Et.heading.style.textTransform,
          textShadow:
            (null === (O = t.options) ||
            void 0 === O ||
            null === (A = O.font) ||
            void 0 === A
              ? void 0
              : A.text_shadow) || Et.heading.style.textShadow,
        },
        boxModel: {
          width: 'auto',
          height: 'auto',
          margin: {
            top:
              ...
              void 0 === S
                ? void 0
                : S.top) || Et.heading.boxModel.margin.top,
            bottom:
              (null === (Z = t.options) ||
              void 0 === Z ||
              null === (L = Z.layout) ||
              ...
              void 0 === U
                ? void 0
                : U.bottom) || Et.heading.boxModel.margin.bottom,
            left:
              (null === (B = t.options) ||
              void 0 === B ||
              null === (F = B.layout) ||
              ...
              void 0 === W
                ? void 0
                : W.left) || Et.heading.boxModel.margin.left,
            right:
              (null === (q = t.options) ||
              void 0 === q ||
              null === (H = q.layout) ||
              ...
              void 0 === N
                ? void 0
                : N.right) || Et.heading.boxModel.margin.right,
          },
          padding: {
            top:
              (null === (X = t.options) ||
              ...
              void 0 === $
                ? void 0
                : $.top) || Et.heading.boxModel.padding.top,
            bottom:
              (null === (G = t.options) ||
              void 0 === G ||
              null === (J = G.layout) ||
              ...
              void 0 === tt
                ? void 0
                : tt.bottom) || Et.heading.boxModel.padding.bottom,
            left:
              (null === (et = t.options) ||
              void 0 === et ||
              null === (nt = et.layout) ||
              ...
              void 0 === it
                ? void 0
                : it.left) || Et.heading.boxModel.padding.left,
            right:
              (null === (rt = t.options) ||
              void 0 === rt ||
              null === (at = rt.layout) ||
              ...
              void 0 === ct
                ? void 0
                : ct.right) || Et.heading.boxModel.padding.right,
          },
        },
      };
    }
      ...
      return {
        ...
        other: {
          ...
          classes:
            ...
            void 0 === c
              ? void 0
              : c.classes) || Et.image.other.classes,
          css:
            (null === (l = t.options) ||
            void 0 === l ||
            null === (u = l.general) ||
        ...
        boxModel: {
          ...
          margin: {
            top:
              ...
              void 0 === m
                ? void 0
                : m.top) || Et.image.boxModel.margin.top,
            bottom:
              (null === (f = t.options) ||
              void 0 === f ||
              null === (g = f.layout) ||
              ...
              void 0 === v
                ? void 0
                : v.bottom) || Et.image.boxModel.margin.bottom,
            left:
              (null === (y = t.options) ||
              void 0 === y ||
              null === (_ = y.layout) ||
              ...
              void 0 === x
                ? void 0
                : x.left) || Et.image.boxModel.margin.left,
            right:
              (null === (k = t.options) ||
              void 0 === k ||
              null === (j = k.layout) ||
              ...
              void 0 === I
                ? void 0
                : I.right) || Et.image.boxModel.margin.right,
          },
          padding: {
            top:
              (null === (C = t.options) ||
              ...
              void 0 === A
                ? void 0
                : A.top) || Et.image.boxModel.padding.top,
            bottom:
              (null === (P = t.options) ||
              void 0 === P ||
              null === (T = P.layout) ||
              ...
              void 0 === S
                ? void 0
                : S.bottom) || Et.image.boxModel.padding.bottom,
            left:
              (null === (Z = t.options) ||
              void 0 === Z ||
              null === (L = Z.layout) ||
              ...
              void 0 === U
                ? void 0
                : U.left) || Et.image.boxModel.padding.left,
            right:
              (null === (B = t.options) ||
              void 0 === B ||
              null === (F = B.layout) ||
              ...
              void 0 === W
                ? void 0
                : W.right) || Et.image.boxModel.padding.right,
          },
        },
      };
    }
        ...
        ft = {
          ...
          other: {
            ...
            classes:
              ...
              void 0 === u
                ? void 0
                : u.classes) || Et.button.other.classes,
            css:
              (null === (p = t.options) ||
              void 0 === p ||
              null === (d = p.general) ||
          ...
          style: {
            backgroundColor:
              ...
              void 0 === m
                ? void 0
                : m.bg_color) || Et.button.style.backgroundColor,
            borderRadius:
              (null === (f = t.options) ||
              void 0 === f ||
              null === (g = f.button) ||
              void 0 === g
                ? void 0
                : g.border_radius) || Et.button.style.borderRadius,
            fontFamily:
              (null === (b = t.options) ||
              void 0 === b ||
              null === (v = b.font) ||
              void 0 === v
                ? void 0
                : v.font_family) || Et.button.style.fontFamily,
            fontSize:
              (null === (y = t.options) ||
              void 0 === y ||
              null === (_ = y.font) ||
              void 0 === _
                ? void 0
                : _.font_size) || Et.button.style.fontSize,
            fontWeight:
              (null === (w = t.options) ||
              void 0 === w ||
              null === (x = w.font) ||
              void 0 === x
                ? void 0
                : x.font_weight) || Et.button.style.fontWeight,
            fontStyle:
              (null === (k = t.options) ||
              void 0 === k ||
              null === (j = k.font) ||
              void 0 === j
                ? void 0
                : j.font_style) || Et.button.style.fontStyle,
            lineHeight:
              (null === (M = t.options) ||
              void 0 === M ||
              null === (I = M.button) ||
              void 0 === I
                ? void 0
                : I.height) || Et.button.style.lineHeight,
            color:
              (null === (C = t.options) ||
              void 0 === C ||
              null === (E = C.button) ||
              void 0 === E
                ? void 0
                : E.text_color) || Et.button.style.color,
            textAlign:
              (null === (O = t.options) ||
              void 0 === O ||
              null === (A = O.font) ||
              void 0 === A
                ? void 0
                : A.text_align) || Et.button.style.textAlign,
            textDecoration:
              (null === (P = t.options) ||
              void 0 === P ||
              null === (T = P.font) ||
              void 0 === T
                ? void 0
                : T.text_decoration) || Et.button.style.textDecoration,
            textTransform:
              (null === (z = t.options) ||
              void 0 === z ||
              null === (S = z.font) ||
              void 0 === S
                ? void 0
                : S.text_transform) || Et.button.style.textTransform,
            textShadow:
              (null === (Z = t.options) ||
              void 0 === Z ||
              null === (L = Z.font) ||
              void 0 === L
                ? void 0
                : L.text_shadow) || Et.button.style.textShadow,
          },
          boxModel: {
            width: 'auto',
            height: 'auto',
            margin: {
              top:
                ...
                void 0 === F
                  ? void 0
                  : F.top) || Et.button.boxModel.margin.top,
              bottom:
                (null === (D = t.options) ||
                void 0 === D ||
                null === (W = D.layout) ||
                ...
                void 0 === H
                  ? void 0
                  : H.bottom) || Et.button.boxModel.margin.bottom,
              left:
                (null === (Y = t.options) ||
                void 0 === Y ||
                null === (N = Y.layout) ||
                ...
                void 0 === K
                  ? void 0
                  : K.left) || Et.button.boxModel.margin.left,
              right:
                (null === (V = t.options) ||
                void 0 === V ||
                null === ($ = V.layout) ||
                ...
                void 0 === J
                  ? void 0
                  : J.right) || Et.button.boxModel.margin.right,
            },
            padding: {
              top:
                (null === (Q = t.options) ||
                ...
                void 0 === nt
                  ? void 0
                  : nt.top) || Et.button.boxModel.padding.top,
              bottom:
                (null === (ot = t.options) ||
                void 0 === ot ||
                null === (it = ot.layout) ||
                ...
                void 0 === at
                  ? void 0
                  : at.bottom) || Et.button.boxModel.padding.bottom,
              left:
                (null === (st = t.options) ||
                void 0 === st ||
                null === (ct = st.layout) ||
                ...
                void 0 === ut
                  ? void 0
                  : ut.left) || Et.button.boxModel.padding.left,
              right:
                (null === (pt = t.options) ||
                void 0 === pt ||
                null === (dt = pt.layout) ||
                ...
                void 0 === mt
                  ? void 0
                  : mt.right) || Et.button.boxModel.padding.right,
            },
          },
        };
      return (
        1 === ft.newTab && (ft.newTab = !0),
        0 === ft.newTab && (ft.newTab = !1),
        ft
      );
    }
    function ke(t) {
      ...
      return {
        ...
        other: {
          ...
          classes:
            ...
            void 0 === v
              ? void 0
              : v.classes) || Et.video.other.classes,
          css:
            (null === (y = t.options) ||
            void 0 === y ||
            null === (_ = y.general) ||
        ...
        boxModel: {
          ...
          margin: {
            top:
              ...
              void 0 === j
                ? void 0
                : j.top) || Et.video.boxModel.margin.top,
            bottom:
              (null === (M = t.options) ||
              void 0 === M ||
              null === (I = M.layout) ||
              ...
              void 0 === E
                ? void 0
                : E.bottom) || Et.video.boxModel.margin.bottom,
            left:
              (null === (O = t.options) ||
              void 0 === O ||
              null === (A = O.layout) ||
              ...
              void 0 === T
                ? void 0
                : T.left) || Et.video.boxModel.margin.left,
            right:
              (null === (z = t.options) ||
              void 0 === z ||
              null === (S = z.layout) ||
              ...
              void 0 === L
                ? void 0
                : L.right) || Et.video.boxModel.margin.right,
          },
          padding: {
            top:
              (null === (R = t.options) ||
              ...
              void 0 === F
                ? void 0
                : F.top) || Et.video.boxModel.padding.top,
            bottom:
              (null === (D = t.options) ||
              void 0 === D ||
              null === (W = D.layout) ||
              ...
              void 0 === H
                ? void 0
                : H.bottom) || Et.video.boxModel.padding.bottom,
            left:
              (null === (Y = t.options) ||
              void 0 === Y ||
              null === (N = Y.layout) ||
              ...
              void 0 === K
                ? void 0
                : K.left) || Et.video.boxModel.padding.left,
            right:
              (null === (V = t.options) ||
              void 0 === V ||
              null === ($ = V.layout) ||
              ...
              void 0 === J
                ? void 0
                : J.right) || Et.video.boxModel.padding.right,
          },
        },
      };
    }
    function je(t) {
      ...
      0 ===
        ...
        (q =
          ...
          void 0 === W
            ? void 0
            : W.iframe_width) || Et.youtube.boxModel.width);
      var H = {
        type: 'YouTube',
        embedCode:
          (null === (o = t.options) ||
          ...
          void 0 === i
            ? void 0
            : i.embed_code) || Et.youtube.embedCode,
        allowFullscreen:
          (null === (r = t.options) ||
          void 0 === r ||
          null === (a = r.youtube) ||
          void 0 === a
            ? void 0
            : a.allow_fullscreen) || Et.youtube.allowFullscreen,
        other: { id: '', classes: '', css: '' },
        style: {},
        boxModel: {
          width: q,
          height:
            ...
            void 0 === c
              ? void 0
              : c.iframe_height) || Et.youtube.boxModel.height,
          margin: {
            top:
              (null === (l = t.options) ||
              void 0 === l ||
              ...
              void 0 === d
                ? void 0
                : d.top) || Et.youtube.boxModel.margin.top,
            bottom:
              (null === (h = t.options) ||
              void 0 === h ||
              null === (m = h.layout) ||
              ...
              void 0 === g
                ? void 0
                : g.bottom) || Et.youtube.boxModel.margin.bottom,
            left:
              (null === (b = t.options) ||
              void 0 === b ||
              null === (v = b.layout) ||
              ...
              void 0 === _
                ? void 0
                : _.left) || Et.youtube.boxModel.margin.left,
            right:
              (null === (w = t.options) ||
              void 0 === w ||
              null === (x = w.layout) ||
              ...
              void 0 === j
                ? void 0
                : j.right) || Et.youtube.boxModel.margin.right,
          },
          padding: {
            top:
              (null === (M = t.options) ||
              ...
              void 0 === E
                ? void 0
                : E.top) || Et.youtube.boxModel.padding.top,
            bottom:
              (null === (O = t.options) ||
              void 0 === O ||
              null === (A = O.layout) ||
              ...
              void 0 === T
                ? void 0
                : T.bottom) || Et.youtube.boxModel.padding.bottom,
            left:
              (null === (z = t.options) ||
              void 0 === z ||
              null === (S = z.layout) ||
              ...
              void 0 === L
                ? void 0
                : L.left) || Et.youtube.boxModel.padding.left,
            right:
              (null === (R = t.options) ||
              void 0 === R ||
              null === (U = R.layout) ||
              ...
              void 0 === F
                ? void 0
                : F.right) || Et.youtube.boxModel.padding.right,
          },
        },
      };
      return (
    ...
    var Ce = function (t) {
        ...
        i = (function (t) {
          return {
            ...
            tooltips: {
              ...
              fullscreen_background_opacity:
                Mt.tooltips.fullscreen_background_opacity,
            },
            zooming: {
              enable_zooming: Te(t.zooming.enable_zooming),
              max_zoom: t.zooming.max_zoom,
              limit_max_zoom_to_image_size: Te(
                t.zooming.limit_max_zoom_to_image_size
              ),
            ...
            object_list: {
              ...
              show_only_objects_from_active_artboard:
                Mt.object_list.show_only_objects_from_active_artboard,
            },
            custom_code: {
      ...
      if (
        ...
        for (var s in t.spots) t.spots[s] = m.ZB({}, Se, t.spots[s]);
        var c,
          l,
          u = Me(t.spots);
        try {
      ...
      if (
        ...
        var j,
          M = Me(
            null === (k = t.layers) || void 0 === k ? void 0 : k.layers_list
          );
        try {
          var I = function () {
            var t = j.value,
            ...
            (e.id = m.k$()),
              ...
              e.image_url
                ? (e.background_type = 'image')
                : (e.background_type = 'color'),
    ...
    function Oe(t) {
      ...
      try {
        for (i.s(); !(o = i.n()).done; ) {
          var r = o.value;
          if (r.id === shape.layerID)
            return { width: r.image_width, height: r.image_height };
        }
      } catch (t) {
        i.e(t);
      } finally {
            ...
            (a.type !== jt.p5 &&
              ...
              '' !== o
                ? ((a.default_style.parent_filters = i.default_style.filters),
                  (a.mouseover_style.parent_filters =
                    i.mouseover_style.filters))
                : ((a.default_style.parent_filters = []),
                  (a.mouseover_style.parent_filters = []))),
            a.children)
          ) {
    ...
    function Fe(t) {
      ...
      try {
        for (n.s(); !(e = n.n()).done; ) {
          var o = e.value;
          o.type !== jt.p5 &&
            0 === o.tooltip_content.length &&
            (o.tooltip.enable_tooltip = !1),
            o.children && Fe(o.children);
        }
      } catch (t) {
        n.e(t);
      } finally {
        ...
        return (
          (0, dt.Z)(t, [
                          ...
                          switch ((t.prev = t.next)) {
                            ...
                            case 7:
                              return (
                                ...
                                (this.root.dataset.imageMapId =
                                  this.store.getID()),
                                (this.root.dataset.imageMapName =
                                  this.store.getName()),
                                (this.containerEl =
                                  this.root.querySelector('.imp-container')),
                                (this.canvasWrap =
                                  this.root.querySelector('.imp-canvas')),
                                (this.scaleWrap =
                                  this.canvasWrap.querySelector('.imp-scale')),
                                (this.translateWrap =
                                  this.canvasWrap.querySelector(
                                    '.imp-translate'
                                  )),
                                (this.UIWrap =
                                  this.root.querySelector('.imp-ui')),
                                this.setBackground(),
                                (t.next = 18),
                                this.adjustSize()
                              );
                            ...
                            case 20:
                              (this.eventController = new gt(this.store)),
                                ...
                                (this.fullscreenController = new _t(
                                  this.store,
                                ...
                                this.store
                                  ...
                                  .appendChild(
                                    this.objectController
                                      .imageBackgroundsContainer
                                  ),
                                this.root.appendChild(
                                  this.objectController.stylesheet
                                ),
            ...
            },
            {
              ...
              value: function () {
                var t =
                  'light' === this.store.state.general.ui_theme
                    ? 'imp-ui-light'
                    : 'imp-ui-dark';
                          ...
                          switch ((t.prev = t.next)) {
                            case 0:
                              if (
                                !this.store.getArtboard().image_url ||
                                'image' !==
                                  this.store.getArtboard().background_type
                              ) {
                                t.next = 9;
                                break;
                              }
                              return (
                                (t.next = 3),
                                (0, m.po)(this.store.getArtboard().image_url)
                              );
                            case 3:
                              if ((e = t.sent)) {
                                t.next = 7;
                            ...
                            case 12:
                              ...
                              if (
                                'image' !==
                                (i = o.value).default_style.background_type
                              ) {
                                t.next = 17;
                                break;
                              }
                              return (
                                (t.next = 17),
                                (0, m.po)(
                                  i.mouseover_style.background_image_url
                                )
                              );
                            case 17:
                              t.next = 12;
                        ...
                        for (;;)
                          switch ((t.prev = t.next)) {
                            case 0:
                              if (
                                !this.store.getImage() ||
                                0 !== (0, m.Yo)(this.canvasWrap).height
                              ) {
                                t.next = 5;
                                break;
                              }
                            ...
                            case 5:
                              if (
                                ...
                                (r =
                                  ...
                                  this.store.getArtboard().height),
                                (a = 0),
                                this.store.state.object_list
                                  .enable_object_list &&
                                  'default' ===
                                    this.store.state.object_list.menu_style &&
                                  ((a = this.store.getIsMenuMobile() ? 0 : 240),
                                  'right' ==
                                    this.store.state.object_list
                                      .menu_position &&
                                    (this.store.getContainer().style.paddingRight =
                                      a + 'px'),
                                  'left' ==
                                    this.store.state.object_list
                                      .menu_position &&
                                    (this.store.getContainer().style.paddingLeft =
                                      a + 'px')),
                                !this.launchParams.isFullscreen)
                              ) {
                                t.next = 13;
                              ...
                              return (
                                (this.store.getCanvasWrap().style.width =
                                  this.calculateFullscreenCanvasSize().width +
                                  'px'),
                                (this.store.getCanvasWrap().style.height =
                                  this.calculateFullscreenCanvasSize().height +
                                  'px'),
                                t.abrupt('return')
                              );
                            case 13:
                              (n = this.store.state.general.responsive
                                ...
                                : this.store.getArtboard().width),
                                (i = (o = n - a) / r),
                                (this.store.getContainer().style.width =
                                  n + 'px'),
                                (this.store.getCanvasWrap().style.width =
                                  o + 'px'),
                                (this.store.getCanvasWrap().style.height =
            ...
            },
            {
              ...
              value: function () {
                this.background && this.background.remove(),
                  ...
                  'image' === this.store.getArtboard().background_type &&
                    this.store.getArtboard().image_url &&
                    this.scaleWrap.prepend(this.image),
                  'color' === this.store.getArtboard().background_type &&
                    (this.background ||
            ...
            },
            {
              ...
              value: function () {
                ...
                if (this.store.state.custom_code.custom_css) {
                  var e = document.createElement('style');
                  (e.className = 'viewer-styles-four'(
    ...
    (window.ImageMapPro.init = function (t, e) {
      ...
      window.ImageMapPro.instances[
        (null === (n = e.general) || void 0 === n ? void 0 : n.name) ||
          'Default'
      ] = o;
    }),
      'undefined' != typeof $ &&
    ...
    (window.debug = function (t) {
      Ye ||
        ((Ye = document.createElement('div')).setAttribute('id', 'debug'),
        ...
        (Xe = setTimeout(function () {
          Ne = setInterval(function () {
            (Ye.style.opacity = 0.75 * Ye.style.opacity),
              Ye.style.opacity < 0.1 &&
                ((Ye.style.opacity = 0), clearInterval(Ne));
          }, 50);
        }, 1e3));
    }),
